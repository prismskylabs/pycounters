...
class BaseReporter(object):
    ...
    def start_auto_report(self,seconds=300):
        """ depracted. Added for bacwards compatiblity and will be removed. """
        from .. import start_auto_reporting as global_start_auto_reporting

        global_start_auto_reporting(seconds=seconds)

    def stop_auto_report(self):
        """ depracted. Added for bacwards compatiblity and will be removed. """
        from .. import stop_auto_reporting as global_stop_auto_reporting

        global_stop_auto_reporting()
